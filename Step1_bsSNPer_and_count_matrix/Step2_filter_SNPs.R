...
## The vcf files:
## Set working directory to the output directory you used for BS-SNPer. It contains SNP out files named such as "SNP_Subject1.out" + temporary files. I recommend checking that all SNP out files end with "SNP finished", indicating that BS-SNPer wasn't interrupted.
